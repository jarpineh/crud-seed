...
function Ctrl($scope, $resource, Server, Book) {
	var empty = {
    name: '',
    address:{
      line1: '',
...
Ctrl.$inject = ['$scope', '$resource', 'Server', 'Book']; //Dependency injection apparently needs this, but in simple examples it can guess the values to inject
